...
// type
const TYPE_MONSTER = 0x1n;
const TYPE_SPELL = 0x2n;
const TYPE_TRAP = 0x4n;

// color type
const TYPE_NORMAL = 0x10n;
const TYPE_EFFECT = 0x20n;
const TYPE_FUSION = 0x40n;
const TYPE_RITUAL = 0x80n;
const TYPE_SYNCHRO = 0x2000n;
const TYPE_XYZ = 0x800000n;
const TYPE_PENDULUM = 0x1000000n;
const TYPE_LINK = 0x4000000n;
const TYPES_EXTRA = TYPE_FUSION | TYPE_SYNCHRO | TYPE_XYZ | TYPE_LINK;

// extype
const TYPE_SPIRIT = 0x200n;
const TYPE_UNION = 0x400n;
const TYPE_DUAL = 0x800n;
const TYPE_TUNER = 0x1000n;
const TYPE_TOKEN = 0x4000n;
const TYPE_FLIP = 0x200000n;
const TYPE_TOON = 0x400000n;
const TYPE_SPSUMMON = 0x2000000n;

// spell type
const TYPE_QUICKPLAY = 0x10000n;
const TYPE_CONTINUOUS = 0x20000n;
const TYPE_EQUIP = 0x40000n;
//const TYPE_RITUAL
const TYPE_FIELD = 0x80000n;

// trap type
//const TYPE_CONTINUOUS
const TYPE_COUNTER = 0x100000n;
